...
namespace HelloWorld.Assets.Scripts.Neo
{
    ...
    public partial class OutpostSaveData : NeoGeneratedClassValue, IReadOnlyOutpostSaveData
    {
        ...
        {
            return NeoGeneratedTypesSupport.GetOrCreateGeneratedClassValue<OutpostSaveData>(client, node, static (factoryClient, factoryNode) =>
            {
                var clientClassId = factoryNode.ClassId;
                return clientClassId switch
                {
                    _ => new OutpostSaveData(factoryClient, factoryNode, true, NeoValueOwnership.Asset),
                };
            });
        }
        ...
        internal static OutpostSaveData CreateWritable(NeoClient client, NeoMemberClassWritable node)
        {
            return NeoGeneratedTypesSupport.GetOrCreateGeneratedClassValue<OutpostSaveData>(client, node, static (factoryClient, factoryNode) =>
            {
                ...
                return clientClassId switch
                {
                    _ => new OutpostSaveData(factoryClient, factoryNode, false, factoryNode.ownership),
                };
            });
        }
