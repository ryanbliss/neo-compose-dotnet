...
namespace HelloWorld.Assets.Scripts.Neo
{
    ...
    public abstract partial class NeoTile : NeoGeneratedTileValue, IReadOnlyNeoTile, INeoSmartTileSource
    {
        ...
        {
            return NeoGeneratedTypesSupport.GetOrCreateGeneratedClassValue<NeoTile>(client, node, static (factoryClient, factoryNode) =>
            {
        ...
        public virtual NeoVector2Int Cell
        {
            ...
            set
            {
                ...
                NeoGeneratedTypesSupport.SetPlacementVector2Int(writableNode, "Cell", value);
            }
        }
