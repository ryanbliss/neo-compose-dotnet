...
namespace HelloWorld.Assets.Scripts.Neo
{
    ...
    public partial class RecoveryCacheObject : ConsoleObject, IReadOnlyRecoveryCacheObject
    {
        ...
        {
            return NeoGeneratedTypesSupport.GetOrCreateGeneratedClassValue<RecoveryCacheObject>(client, node, static (factoryClient, factoryNode) =>
            {
                var clientClassId = factoryNode.ClassId;
                return clientClassId switch
                {
                    _ => new RecoveryCacheObject(factoryClient, factoryNode, true, NeoValueOwnership.Asset),
                };
            });
        }
        ...
        internal new static RecoveryCacheObject CreateWritable(NeoClient client, NeoMemberClassWritable node)
        {
            return NeoGeneratedTypesSupport.GetOrCreateGeneratedClassValue<RecoveryCacheObject>(client, node, static (factoryClient, factoryNode) =>
            {
                ...
                return clientClassId switch
                {
                    _ => new RecoveryCacheObject(factoryClient, factoryNode, false, factoryNode.ownership),
                };
            });
        }
