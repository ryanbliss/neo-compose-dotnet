...
public sealed class NeoTextNodeMemory
{
    ...
    [NeoProperty("4042fd7d-88d4-4acf-81de-13052c70673e", Locked = true, Code = @"return this.VisitCount > 0;", RetJson = @"{""required"":true,""type"":1}", ExtraJson = @"{""system"":{""disallow"":[""editRecord"",""deleteRecord""],""reason"":""Generated dialogue memory schema required by the Neo Compose dialogue runtime.""}}")]
