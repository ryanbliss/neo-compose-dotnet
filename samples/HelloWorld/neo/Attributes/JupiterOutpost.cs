...
{
    [NeoProperty("48c7bc64-fc1a-41bc-becb-4d24da7df9aa", ExtendsId = "514a79c5-dd23-4ede-9fc8-b07b3c866fe5", Code = @"	return $""{this.Name}, {this.Moon}, {this.Planet}"";", RetJson = @"{""required"":true,""type"":3}", ExtraJson = @"{""system"":null}")]
