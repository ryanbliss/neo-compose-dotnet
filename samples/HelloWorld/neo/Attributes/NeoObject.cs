...
[NeoCustomType("4c2aa621-e662-419f-a5b5-d8dcfab9b29b", ExtraJson = @"{""system"":{""disallow"":[""editRecord"",""deleteRecord"",""selectRecord""],""reason"":""Locked world authoring system type required by the Neo Compose Tile Grid Builder."",""worldKind"":""object""}}")]
public abstract class NeoObject : NeoObjectBase
{
    [NeoLookup("cf6e9aa2-dd4b-4673-a83b-5a15e617eb9a", Locked = true, CollectionId = "7fb51db7-60c7-4064-bcde-6938acea4fe8", DefaultJson = @"null", ExtraJson = @"{""collectionValueId"":null,""system"":{""disallow"":[""editRecord"",""deleteRecord"",""selectRecord""],""reason"":""Locked world authoring system type required by the Neo Compose Tile Grid Builder.""}}")]
    public NeoLookupRef DefaultLayer { get; init; }

    [NeoLookup("5915099d-fc2e-4f4a-875c-dad704472d05", Locked = true, CollectionId = "7fb51db7-60c7-4064-bcde-6938acea4fe8", DefaultJson = @"{""value"":null}", ExtraJson = @"{""collectionValueId"":null,""system"":{""disallow"":[""editRecord"",""deleteRecord"",""selectRecord""],""reason"":""Locked world authoring system type required by the Neo Compose Tile Grid Builder.""}}")]
