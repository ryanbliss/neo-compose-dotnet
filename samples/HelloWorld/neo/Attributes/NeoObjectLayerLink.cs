...
{
    [NeoLookup("9cc0ab67-e138-4d11-8011-fab7d7a75b13", Locked = true, CollectionId = "7fb51db7-60c7-4064-bcde-6938acea4fe8", DefaultJson = @"null", ExtraJson = @"{""collectionValueId"":null,""system"":{""disallow"":[""editRecord"",""deleteRecord"",""selectRecord""],""reason"":""Locked world authoring system type required by the Neo Compose Tile Grid Builder.""}}")]
