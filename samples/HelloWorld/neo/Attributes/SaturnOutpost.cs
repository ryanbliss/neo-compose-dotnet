...
{
    [NeoGetter("33e86f10-7989-4d82-9156-631a19e3bf06", ExtendsId = "514a79c5-dd23-4ede-9fc8-b07b3c866fe5", Code = @"	return $""{this.Name}, {this.Moon}, {this.Planet}"";", RetJson = @"{""required"":true,""type"":3}", ExtraJson = @"{""system"":null}")]
