...
[NeoCustomType("7cb1b706-95d2-4465-8e75-c82a6b7d8830", Hidden = true, ExtraJson = @"{""system"":{""disallow"":[""editRecord"",""deleteRecord"",""selectRecord""],""reason"":""Locked world authoring system type required by the Neo Compose Tile Grid Builder."",""worldKind"":""spriteObject""}}")]
public abstract class NeoSpriteObject : NeoObjectBase
{
