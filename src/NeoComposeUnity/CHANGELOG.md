...
- The write plan drops its runtime-leaf branch: raw row writes to a Position (`SetWritableValue`, vector component wrappers, structured-leaf field writes) validate structurally and rebuild the affected layers, as they did before 0.39.7.
