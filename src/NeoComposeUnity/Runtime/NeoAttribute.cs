    ...
    public abstract class NeoAttribute : NeoNode, System.IDisposable
    {
            ...
            string? overrideValueId)
        {
            ...
            return attribute switch
            {
                ...
                NSFunctionAttribute nsf => new NeoAttributeNSFunction(client, nsf, overrideValueId),
            ...
            NeoValueOwnership ownership = NeoValueOwnership.Session)
        {
            ...
            return attribute switch
            {
                ...
                NSFunctionAttribute nsf => new NeoAttributeNSFunction(client, nsf, overrideValueId, ownership),
        ...
        private static bool IsWritableCompatible(Attribute attribute, NeoAttribute existing)
        {
            return attribute switch
            {
                ...
                NSFunctionAttribute => existing is NeoAttributeNSFunction,
