...
namespace NeoCompose.Runtime
{
    ...
    internal static class NeoWorldLayerLinkResolver
    {
            ...
            bool isTileLink)
        {
            ...
            if (linkClass.EffectiveModifier == NeoClassModifierKind.Abstract)
            {
                throw new InvalidOperationException(
            ...
            if (systemBase.EffectiveModifier != NeoClassModifierKind.Abstract
            ...
            bool isTileLink)
        {
            ...
            if (targetClass.EffectiveModifier == NeoClassModifierKind.Abstract)
            {
                throw new InvalidOperationException(
